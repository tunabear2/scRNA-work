...
출력:  checkpoint/GeneFunction/{task}_best_model.pth
       results/06_multiclass_gene_function/metrics.json
"""
...
def extract_gene_emb():
    """base_weight.ckpt에서 gene_emb를 추출해 PyTorch tensor로 저장"""
...
def run_go_task(task, top, gene_emb, model_idx, seed=5, num_epochs=5, batch=4, interval=0.01):
    ...
    return {"AUPR": test_aupr, "Fmax": test_fmax,
            "best_epoch": best_epoch, "checkpoint": best_model_path}
